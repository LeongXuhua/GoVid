 ...
 {/*Work Status*/}
          <View style={styles.statusBox}>
            <TouchableOpacity
              ...
              {(!user)?[<MaterialCommunityIcons name='home' size={45} style={{ color: 'green' }} />,<Text>Home</Text>]:user.checkIn?[<MaterialCommunityIcons name='office-building' size={45} style={{ color: '#007AFF' }} />,<Text>{user.checkIn.location}</Text>]:workStatus==='office'?[<MaterialCommunityIcons name='office-building' size={45} style={{ color: '#007AFF' }} />,<Text>Office</Text>]:[<MaterialCommunityIcons name='home' size={45} style={{ color: 'green' }} />,<Text>Home</Text>]}
            </TouchableOpacity>
          </View>
 ...
 {/*Check Out*/}
        ...
        <View style={styles.categoryContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('Employee', { screen: 'ScanQR' })
            }>
          ...
          <TouchableOpacity
            style={styles.categoryBtn}
            onPress={() =>
              navigation.navigate('Employee', { screen: 'UploadART' })
            }>
            <View style={styles.categoryIcon}>
              <MaterialCommunityIcons
                name="newspaper-plus"
        ...
        <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.categoryBtn}
            onPress={() =>
              navigation.navigate('Employee', { screen: 'BookVaccination' })
            }>
            <View style={styles.categoryIcon}>
              <MaterialCommunityIcons
                name="doctor"
          ...
          <TouchableOpacity
            style={styles.categoryBtn}
            onPress={() =>
              navigation.navigate('Employee', { screen: 'BookTest' })
            }>
            <View style={styles.categoryIcon}>
              <MaterialCommunityIcons
                name="medical-bag"
        ...
        <View style={[styles.categoryContainer, { marginTop: 10 }]}>
          ...
          <TouchableOpacity
            style={styles.categoryBtn}
            onPress={() =>
              navigation.navigate('Employee', { screen: 'TravelInformation' })
            }>
            <View style={styles.categoryIcon}>
              <MaterialCommunityIcons
